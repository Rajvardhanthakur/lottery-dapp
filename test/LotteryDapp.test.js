...
const { generateLuckyNumbers, addDays } = require("../utils/generatorFn");
...
describe('LotteryDapp', () => {
  ...
  beforeEach(async () => {
    ...
    [serviceAccount, participant1, participant2, participant3, participant4, participant5] = await ethers.getSigners()
  ...
  describe('Lucky Numbers Generation', () => {
    ...
    it('Should confirm lucky numbers generation', async () => {
      result = await contract.getLotteryLuckyNumbers(lotteryId)
      expect(result).to.have.lengthOf(0)

      await contract.getLuckyNumbers(lotteryId, generateLuckyNumbers(numberToGenerate))
